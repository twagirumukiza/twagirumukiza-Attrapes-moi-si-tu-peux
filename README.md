...
## Correctif (v3.1)
- **Bug corrigé** : le pion de l'IA (ou de l'adversaire) disparaissait instantanément dès qu'il était rattrapé, au lieu de rester visible pendant la course puis de disparaître après l'effet de capture. La piste ne se resserre désormais qu'une fois l'animation de capture terminée.
